...
const Navbar = () => {
  return (
    <div className=' flex gap-3 p-3 justify-between items-center  '>
      <div className='flex gap-1 bg-black p-3 rounded-3xl justify-center items-center'>
        <h1 className='text-4xl text-white font-bold  '>StudentHub</h1><Github size={52} color="#ffb8ec" />  
      </div>
